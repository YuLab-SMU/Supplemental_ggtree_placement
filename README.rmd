...
- **`Fig1.pdf`**Workflow diagram of treeio and ggtree in processing phylogenetic placement data, **`Fig2.pdf`**, **`Fig3.pdf`**,**`Fig4.pdf`**: Figures representing various visualizations of the phylogenetic analysis.
...
- **`generate_simulate_jplace_data.r`**: R script used to generate simulated `.jplace` data files.
- **`test_jp_1k.jplace`**, **`test_jp_10k.jplace`**, **`test_jp_50k.jplace`**, **`test_jp_100k.jplace`**: `.jplace` format files of various sizes, used for testing and validation of data analysis workflows.
