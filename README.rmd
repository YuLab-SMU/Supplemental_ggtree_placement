...
- **`Fig1.pdf`**, **`Fig2.pdf`**, **`Fig3.pdf`**: Figures representing various visualizations of the phylogenetic analysis.
...
- **`Fig1.tiff`**, **`Fig2.tiff`**, **`Fig3.tiff`**: High-resolution images of the figures in TIFF format.
