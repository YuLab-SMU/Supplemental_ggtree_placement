...
p1 <- ggplot(data = placements,aes(x=like_weight_ratio)) +
    geom_histogram(data=filtered_placements,aes(x=like_weight_ratio,..count..),fill="skyblue",  color="white",size=0.1,binwidth = 0.1) +
    geom_histogram(data=placements,aes(x=like_weight_ratio,..count..),fill="red",  color="black",size=0.8,binwidth = 0.1, alpha=0.5) +
    labs(y="Number of Placements",x="LWR") +
